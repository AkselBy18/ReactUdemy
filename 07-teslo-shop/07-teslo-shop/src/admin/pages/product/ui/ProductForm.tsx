            ...
            <div className="flex justify-between items-center">
                ...
                <div className="flex justify-end mb-10 gap-4">
                    <Button
                        ...
                        variant="outline"
                        disabled={isPending}
                        className={cn(isPending && 'bg-gray-300 cursor-wait')}>
                    ...
                    <Button
                        type="submit"
                        disabled={isPending}
                        className={cn(isPending && 'bg-gray-700')}>
                        ...
                        <div className="bg-white rounded-xl shadow-lg border border-slate-200 p-6">
                            ...
                            <div className="space-y-6">
                                <div>
                                    ...
                                    {
                                        errors.title && (
                                            <p className="text-red-500 text-sm">El titlo es requerido</p>
                                        )
                                    }
                                </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        />
                                        {
                                            errors.price && (
                                                <p className="text-red-500 text-sm">
                                                    El precio debe de ser mayor de cero
                                                </p>
                                            )
                                        }
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        />
                                        {
                                            errors.price && (
                                                <p className="text-red-500 text-sm">
                                                    El stock debe de ser mayor de cero
                                                </p>
                                            )
                                        }
                                    </div>
