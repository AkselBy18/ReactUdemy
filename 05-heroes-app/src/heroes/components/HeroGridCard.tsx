        ...
        <Card className="group overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-gradient-to-br from-white to-gray-50">
            <div className="relative h-64">
                ...
                <div className="absolute top-3 left-3 flex items-center gap-2">
                    <div
                        className={cn(isActive() ? 'bg-green-500' : 'bg-red-500', "w-3 h-3 rounded-full")}
                    />
            ...
            <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-1">
                        ...
                        <Progress value={getProgressValue(hero.strength)} className="h-2 " activeColor='bg-orange-500' />
                    </div>
                    <div className="space-y-1">
                        <div className="flex items-center gap-1">
                        ...
                        <Progress value={getProgressValue(hero.intelligence)} className="h-2" activeColor='bg-blue-500' />
                    </div>
                    <div className="space-y-1">
                        <div className="flex items-center gap-1">
                        ...
                        <Progress value={getProgressValue(hero.speed)} className="h-2" activeColor='bg-green-500' />
                    </div>
                    <div className="space-y-1">
                        <div className="flex items-center gap-1">
                        ...
                        <Progress value={getProgressValue(hero.durability)} className="h-2" activeColor='bg-purple-500' />
                    </div>
                </div>
